      ...
      <div className="container">
        <div className="mainContent">
          ...
          <div style={{ flex: 1 }}>
            ...
            <button style={{ background: '#2563eb', color: '#fff', padding: '0.9rem 2.5rem', border: 'none', borderRadius: 5, fontSize: '1.1rem', fontWeight: 600, cursor: 'pointer', marginBottom: 18, display: 'flex', alignItems: 'center', gap: 8 }}>
